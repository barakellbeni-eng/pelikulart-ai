      ...
      >
        ...
        <Link to="/" className="flex items-center gap-2.5 justify-center mb-8">
          ...
          <span className="text-2xl font-bold tracking-tight uppercase">
            <span className="text-foreground">PELIKULART</span>
        ...
        <div className="glass-card p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-white/[0.05] border border-white/[0.08] rounded-xl pl-10 pr-10 py-3 text-sm text-foreground placeholder:text-muted-foreground outline-none focus:border-primary/50 transition-colors"
              />
              <button
                type="button"
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-white/[0.05] border border-white/[0.08] rounded-xl py-3 text-sm font-medium text-foreground hover:bg-white/[0.08] transition-colors"
          >
