...
const solutions = [
  { title: "100% en français", desc: "Interface, prompts et support dans ta langue." },
  { title: "Mobile Money accepté", desc: "Wave, Orange Money, MTN MoMo — paie depuis ton téléphone." },
  { title: "Prix en FCFA", desc: "Pas de conversion, pas de frais cachés. Tu sais ce que tu paies." },
];
