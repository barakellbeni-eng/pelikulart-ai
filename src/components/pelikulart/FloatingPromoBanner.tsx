...
const FloatingPromoBanner = () => {
  ...
  return (
    <AnimatePresence>
      ...
      >
        <div className="relative overflow-hidden rounded-2xl shadow-2xl bg-gradient-to-br from-[#7c3aed] to-[#ec4899] border border-white/20">
          <button
          ...
          <div className="p-5 relative z-10">
            <div className="flex items-center gap-2 mb-3">
              <span className="bg-lime text-black text-[10px] font-black uppercase tracking-wider px-2 py-0.5 rounded shadow-sm flex items-center gap-1">
                ...
                {(["days", "hours", "minutes", "seconds"] as const).map((unit, i) => (
                  <div key={unit} className="flex items-center gap-1">
                    ...
                    <div className="flex flex-col items-center leading-none">
                      ...
                      <span className="text-[8px] opacity-60 uppercase">{unit.charAt(0)}</span>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <Link to="/training">
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full py-2.5 bg-white text-[#7c3aed] hover:bg-gray-50 font-bold rounded-lg shadow-lg flex items-center justify-center gap-2 text-sm transition-colors group"
              >
                Profiter de l'offre
