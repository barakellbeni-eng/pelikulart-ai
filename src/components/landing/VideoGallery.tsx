...
const VideoGallery = () => {
  ...
  return (
    <section id="gallery" className="py-24 relative">
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full h-full bg-primary/5 blur-[120px] pointer-events-none rounded-full" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
          {videos.map((video, index) => (
            <motion.div
              ...
              className="group"
            >
              <div className="relative rounded-xl border-2 border-primary overflow-hidden shadow-[0_0_20px_hsl(var(--primary)/0.1)] group-hover:shadow-[0_0_30px_hsl(var(--primary)/0.3)] transition-all duration-300">
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-background via-background/80 to-transparent p-6 pt-12 pointer-events-none">
